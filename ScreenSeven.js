      ...
      <Container  style={{backgroundColor:"white"}}>
        ...
        <Content style={{marginTop:0}}contentContainerStyle={{ flexGrow: 1 }}>
          ...
          <View style={{height:"30%",marginRight:"5%",marginTop:"5%",}}>
            <Text style={{color:"black",fontSize:18,textAlign:"right"}}>غير متاح</Text>
            <Text style={{color:"rgb(117,117,117)",fontSize:16,textAlign:"right"}}> انت الأن غير متاح لإستقبال طلبات النقل </Text>
            <TouchableHighlight
              onPress={()=>{if(MapStore.lastLat != null){this.props.navigation.navigate('ScreenEight', { screen: 'ScreenEight' })}}}
              color="black"
              style={styles.touchableHighlight}>
                <Text style={styles.text}>اجعل متاح للعمل</Text>
            </TouchableHighlight>
          </View>
